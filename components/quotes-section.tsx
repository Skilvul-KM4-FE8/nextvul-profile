...
const QuotesSection = () => {
  return (
    <div className='bg-[#261D17] mx-auto'>
      <div className='w-10/12 md:max-w-5xl py-20 mx-auto gap-10 flex flex-col items-center justify-center '>
        <div className='flex justify-center items-center gap-1 flex-col'>
          ...
          <h2 className='text-4xl font-medium'>Let's talk about <span className='text-[#E09144]'> your project</span></h2>
        </div>
        <p className='text-center'>"You're gonna save yourself problems and money in the <br/> long term with software done correctly."</p>
